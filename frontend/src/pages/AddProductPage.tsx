                    ...
                    <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="grid gap-4 mb-4 sm:grid-cols-2">
                                ...
                                <div className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                    <label
                                        htmlFor="category"
                                        className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                    >
                                    ...
                                    <select value={category} onChange={handleCategoryChange}>
                                        ...
                                        <option value="categoria1">Figuras Navideñas</option>
                                        <option value="categoria2">Espejos</option>
                                        <option value="categoria3">Figuras de yeso</option>
                                ...
                                <div className="sm:col-span-2">
                                    ...
                                    <input
                                        ...
                                        placeholder="Escribe la descipcion aqui"
                                    ></input>
                                </div>
